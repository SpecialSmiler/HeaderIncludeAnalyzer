...
int ImguiMain()
{
    ...
    while (!done)
    {
        ...
        {
            ImGui::Begin("Header File Analyzer");

            ImGui::Text("File count = %d", 1);
            ...
            if (ImGui::BeginTable("split", 3, ImGuiTableFlags_None))
            {
                ...
                for (int side = 0; side < 2; side++)
                {
                    ...
                    ImGui::Text("%s", (side == 0) ? "Being included" : "Including");
                    bool child_visible;
                    if (side == 0)
                    {
            ...
            //ImGui::Text("Being Included");
            //ImGui::SameLine();
            //ImGui::Text("Including");

            //if (ImGui::BeginListBox("##ListBox1", ImVec2(200,200)))
            //{
            //    ImGui::EndListBox();
            //}
            //ImGui::SameLine();
            //if (ImGui::BeginListBox("##ListBox2", ImVec2(200, 200)))
            //{
            //    ImGui::EndListBox();
            //}
